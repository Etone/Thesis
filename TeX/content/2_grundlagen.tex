...
\begin{table}[h]
	\begin{center}
		\begin{tabu} to \textwidth{@{}lccX[4,l]X[5,r]@{}}
			\toprule
...
\begin{table}[h]
	\begin{center}
		\begin{tabu}to \textwidth {@{}lX[2,l]X[3,l]@{}}
			\toprule
