...
\newglossaryentry{gls-tarball}{name={Tarball},description={Ein Tarball ist ein Dateisystem, das mit dem Tool tar komptimiert wurde. In den meisten Flääen befindet sich ein komplettes Root-Filesystem in diesem}}
